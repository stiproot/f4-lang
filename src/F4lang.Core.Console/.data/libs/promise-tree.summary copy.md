...
## Summary
PromiseTree is a .NET library that allows you to build a tree of promises and resolve them in a single call. It is useful for building complex workflows that can be easily configured and tested.
