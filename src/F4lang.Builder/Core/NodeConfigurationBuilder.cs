...
public partial class NodeConfigurationBuilder : INodeConfigurationBuilder
{
    ...
    public INodeConfigurationBuilder AddMsgArgs(params IMsg[] args)
    {
        foreach (var arg in args)
        {
            this._nodeConfiguration.Args.Add(arg);
        }
    ...
    public INodeConfigurationBuilder PreProcess(Action<object> preProcess)
    {
        this._nodeConfiguration.PreProcess = preProcess;
        return this;
    }
}
