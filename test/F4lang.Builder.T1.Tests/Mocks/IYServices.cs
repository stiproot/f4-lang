...
namespace F4lang.Builder.T1.Tests.Mocks;
...
// TODO: the order of methods matter here :P
// ie. if `Configure` is before `GetBool`, this test fails...
public interface IY_OutBool_ConfigurableSyncService 
{ 
	bool GetBool(); 
	IY_OutBool_ConfigurableSyncService Configure(bool flag = true); 
}
public class Y_OutBool_ConfigurableSyncService : IY_OutBool_ConfigurableSyncService
{ 
	private bool _flag;
	public bool GetBool() => this._flag;
	public IY_OutBool_ConfigurableSyncService Configure(bool flag = true)
	{
		this._flag = flag;
		return this;
	}
